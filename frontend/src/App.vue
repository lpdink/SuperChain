<template>
        ...
        <div id="all_page" class="all_page">
            <div class="login" id="login">
                ...
                <div class="log-bg">
                    ...
                    <div class="log-logo">SuperChain Client</div>
                </div>
                <div class="log-email">
                    <input type="text" placeholder="Main Server address" :class="'log-input' + (account==''?' log-input-empty':'')" v-model="account">
                    <input type="text" placeholder="Your Log" :class="'log-input' + (account==''?' log-input-empty':'')" v-model="account">
                    <!-- <input type="password" placeholder="Password" :class="'log-input' + (password==''?' log-input-empty':'')"  v-model="password"> -->
                    <a href="javascript:;" class="log-btn" >Submit</a>
                </div>
 ...
 <style scoped>
 .login{position: absolute; overflow: hidden;left: 50%; margin-left: -250px; top:50%; margin-top: -350px; width: 500px; min-height: 555px; z-index: 10; right: 140px; background: #fff;-webkit-border-radius: 5px;
